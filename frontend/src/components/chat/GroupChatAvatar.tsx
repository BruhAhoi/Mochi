    ...
    for (let i = 0; i < limit; i++) {
        ...
        avatars.push(
            <UserAvatar
                ...
                avatarUrl={member.displayName ?? undefined}
            />
        );
    }
    return (
        <div className='relative flex -space-x-2 *:data-[slot=avatar]:ring-background *:data-[slot=avatar]:ring-2'>
            ...
            {participants.length > limit && (
                <div className='flex items-center z-10 justify-center rounded-full size-8 bg-muted ring-2 ring-background text-muted-foreground'>
