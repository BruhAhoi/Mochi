...
const NewGroupChatModal = () => {
  ...
  const handleRemoveFriends = (friend: Friend) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try{
      ...
      if(invitedUsers.length === 0){
        toast.warning("You have to invite at least 1 member")
        return
      }
    ...
    setInvitedUsers([]);
      ...
      console.log("Error handling handleSubmit in NewGroupChatModal", error)
    }
      ...
      <DialogContent className='sm:max-w-106.25 border-none'>
        ...
        <form className='space-y-4' onSubmit={handleSubmit}>
          ...
          <div className='space-y-2'>
            ...
            <SelectedUsersList invitedUsers={invitedUsers} onRemove={handleRemoveFriends}/>
